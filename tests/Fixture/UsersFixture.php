...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'createDate' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => 'current_timestamp()', 'comment' => '', 'precision' => null],
        'updateDate' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'deleteDate' => ['type' => 'datetime', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'createDate' => '2020-12-03 01:56:05',
                'updateDate' => '2020-12-03 01:56:05',
                'deleteDate' => '2020-12-03 01:56:05',
            ],
        ];
        parent::init();
    }
